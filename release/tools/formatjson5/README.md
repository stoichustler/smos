...
To add this project to your build, append `--with //release/tools/formatjson5` to the `fx set`
invocation.
...
Make sure the tests are added to your build by adding `--with //release/packages:formatjson5` to
