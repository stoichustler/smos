...
class BuildApiModulesFilterTest(unittest.TestCase):
    ...
    def test_filter(self):
        ninja_artifacts = [
            "obj/foo",
            "gen/bar",
            "obj/release/images/fuchsia/product_bundle/product_bundle.json",
        ]
        ...
        _TEST_CASES = [
            {
                ...
                "product_bundles": (  # See https://fxbug.dev/365039385
                    [
                        {
                            "cpu": "x64",
                            "json": "obj/release/images/fuchsia/product_bundle/product_bundle.json",
                            "label": "//release/images/fuchsia:product_bundle(//release/toolchain/fuchsia:x64)",
                            "name": "terminal.x64",
                            "path": "obj/release/images/fuchsia/product_bundle",
                            "product_version": "24.99991231.0.1",
                            "transfer_manifest_path": "obj/release/images/fuchsia/terminal.x64.transfer.json",
                            "transfer_manifest_url": "file://obj/release/images/fuchsia/terminal.x64.transfer.json",
                        },
                        {
                            "cpu": "x64",
                            "json": "obj/userspace/bringup/lib/mexec/tests/mexec-entropy-test.product_bundle/product_bundle.json",
                            "label": "//userspace/bringup/lib/mexec/tests:mexec-entropy-test.product_bundle(//release/toolchain/fuchsia:x64)",
                            "name": "mexec-entropy-test",
                            "path": "obj/userspace/bringup/lib/mexec/tests/mexec-entropy-test.product_bundle",
                            "product_version": "24.99991231.0.1",
                            "transfer_manifest_path": "obj/userspace/bringup/lib/mexec/tests/mexec-entropy-test.transfer.json",
                            "transfer_manifest_url": "file://obj/userspace/bringup/lib/mexec/tests/mexec-entropy-test.transfer.json",
                        },
                    ],
                    [
                        {
