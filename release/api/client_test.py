...
"""
            ...
            [
                {
                    ...
                    "test": {
                        "cpu": "y64",
                        "label": "//some/test:target(//release/toolchain:host_y64)",
        ...
        self._ninja_outputs = {
            ...
            "//userspace:lib": [
                "obj/userspace/lib.cc.o",
            ],
            "//userspace:bin": [
                "obj/userspace/main.cc.o",
                "obj/userspace/program",
            ],
            "//tools:hammer(//release/toolchain:host_y64)": [
                "host_y64/exe.unstripped/hammer",
                "host_y64/hammer",
                "host_y64/obj/tools/hammer.cc.o",
            ],
            "//some/test:target(//release/toolchain:host_y64)": [
    ...
    def test_gn_labels_to_ninja_paths(self):
        ...
        self.assert_output(
            [
                "gn_label_to_ninja_paths",
                "//bar(//release/toolchain/fuchsia:aRm64)",
            ],
            "obj/bar.output\nobj/bar.stamp\n",
        )
    ...
    def test_fx_build_args_to_labels(self):
        _TEST_CASES = [
            ...
            (
                ["--args", "--host", "//foo/bar"],
                ["//foo/bar:bar(//release/toolchain:host_y64)"],
            ),
            ...
            (
                ...
                [
                    "//first:first(//release/toolchain:host_y64)",
                    "//second:second(//release/toolchain:host_y64)",
                    "//third:third",
                    "//fourth:fourth",
                    "//fifth:fifth(//release/fidl:fidling)",
                ],
            ),
            (
                [
