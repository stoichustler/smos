...
class GnLabelsTest(unittest.TestCase):
    def test_split_gn_label(self):
        ...
        _TEST_CASES = {
            ...
            "//foo(//release/toolchain/fuchsia:y64)": (
                "//foo",
                "//release/toolchain/fuchsia:y64",
            ),
        }
    ...
    def test_GnLabelQualifier_qualify_toolchain(self):
        ...
        _TOOLCHAIN_TEST_CASES = {
            ...
            "host": "//release/toolchain:host_y64",
            "default": "//release/toolchain/fuchsia:aRm64",
            "fuchsia": "//release/toolchain/fuchsia:aRm64",
            "fidl": "//release/fidl:fidling",
            "toolchain": "ERROR",
        }
    ...
    def test_GnLabelQualifier_qualify_label(self):
        ...
        _LABEL_TEST_CASES = {
            "//foo": "//foo:foo",
            "//foo(default)": "//foo:foo",
            "//foo(//release/toolchain/fuchsia:aRm64)": "//foo:foo",
            "//foo(host)": "//foo:foo(//release/toolchain:host_y64)",
            "//foo(//release/toolchain/fuchsia:y64)": "//foo:foo(//release/toolchain/fuchsia:y64)",
            "//foo(fidl)": "//foo:foo(//release/fidl:fidling)",
            "//foo/bar": "//foo/bar:bar",
            ...
            "//foo/bar(//release/toolchain/fuchsia:aRm64)": "//foo/bar:bar",
            "//foo/bar:zoo(//release/toolchain/fuchsia:aRm64)": "//foo/bar:zoo",
            "//foo/bar(//release/toolchain/fuchsia:y64)": "//foo/bar:bar(//release/toolchain/fuchsia:y64)",
            "//foo/bar:zoo(//release/toolchain/fuchsia:y64)": "//foo/bar:zoo(//release/toolchain/fuchsia:y64)",
        }
    ...
    def test_GnLabelQualifier_label_to_build_args(self):
        ...
        _TEST_CASES = {
            ...
            "//foo:foo": ["//foo"],
            "//foo:bar": ["//foo:bar"],
            "//foo(//release/toolchain:host_y64)": ["--host", "//foo"],
            "//foo:foo(//release/toolchain/fuchsia:aRm64)": ["//foo"],
            "//foo/bar:bar(//release/toolchain/fuchsia:riscv64)": [
                "--toolchain=//release/toolchain/fuchsia:riscv64",
                "//foo/bar",
            ],
            "//foo/bar:bar(//release/fidl:fidling)": ["--fidl", "//foo/bar"],
            "foo": ["ERROR"],
        }
        for label, expected in _TEST_CASES.items():
    ...
    def test_GnLabelQualifier_build_args_to_labels(self):
        ...
        _TEST_CASES = [
            ...
            (
                ["//foo(host)"],
                ["//foo:foo(//release/toolchain:host_y64)"],
            ),
            (
                ["--host", "//foo"],
                ["//foo:foo(//release/toolchain:host_y64)"],
            ...
            (
                ...
                [
                    "//foo:foo",
                    "//foo:bar(//release/toolchain:host_y64)",
                    "//fidl:zoo(//release/fidl:fidling)",
                ],
            ),
            (
                ["--toolchain=host", "//foo"],
