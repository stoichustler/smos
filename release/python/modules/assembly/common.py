...
# TODO(https://fxbug.dev/42170926) Move to python module at //release/python/modules/file_entry
@total_ordering
@dataclass
...
class FileEntry:
    ...
    # TODO(https://fxbug.dev/42170926) Move to python module at //release/python/modules/fini_manfest
    @staticmethod
