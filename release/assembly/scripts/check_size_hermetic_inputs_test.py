                    ...
                    "package_set_budgets": [
                        {
                            ...
                            "packages": [
                                ...
                                "obj/userspace/sys/pkg/bin/pkgctl/pkgctl-bin/package_manifest.json",
                                "obj/userspace/sys/pkg/bin/system-update-committer/system-update-committer/package_manifest.json"
                            ]
                        },
                        {
                            ...
                            "packages": [
                                "obj/userspace/sys/pkg/bin/pkgctl/pkgctl-bin/package_manifest.json",
                                "obj/userspace/sys/pkg/bin/update/update-bin/package_manifest.json"
                            ]
                        }
                    ]
                }""",
