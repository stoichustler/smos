...
# file under //release/info/jiri_generated/
#
# For context, see https://fxbug.dev/335391299
#
# This uses the //release/info/gen_latest_commit_date.py script
...
# Assume this script lives under //release/info/
...
OUTPUT_DIR="${FUCHSIA_DIR}/release/info/jiri_generated"
...
# LINT.ThenChange(//release/info/BUILD.gn)
