...
* Define a "devicetree_fragment" to process dtsi files.
  ```
  import("//release/devicetree/devicetree.gni")
...
* Define a "devicetree_visitor" to provide a shared library visitor for devicetree validation and parsing.
  See //userspace/devices/devicetree/visitors/drivers for example implementations.
  ```
  import("//release/devicetree/devicetree_visitor.gni")
