...
def _reproxy_log_dir() -> str | None:
    # Set by release/rbe/fuchsia-reproxy-wrap.sh.
...
def analyze_rbe_logs(
    ...
    """
    # See release/rbe/fuchsia-reproxy-wrap.sh for the setup of these
...
_RBE_DOWNLOAD_STUB_HELP = "# run //release/rbe/dlwrap.py on this file to download"
_RBE_DOWNLOAD_STUB_SUFFIX = ".dl-stub"

# Filesystem extended attribute for digests.
# This should match the 'xattr_digest' value in release/rbe/fuchsia-reproxy.cfg.
