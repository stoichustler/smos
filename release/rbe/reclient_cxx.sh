...
then
  ...
  # See release/rbe/fuchsia.py:gcc_support_tools() definition.
  ...
  # see def clang_target_to_libdir() in release/rbe/fuchsia.py.
...
remote_cmd_prefix+=(
  ...
  --exec_timeout=10m
  # LINT.ThenChange(/release/rbe/cxx_remote_wrapper.py:compile_cfg)
