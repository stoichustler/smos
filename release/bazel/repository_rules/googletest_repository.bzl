...
def _googletest_repository_impl(repo_ctx):
    ...
    # //release/bazel/update-workspace.py.
    ...
    repo_ctx.execute(
        [
            repo_ctx.path(workspace_dir + "/release/bazel/scripts/git-clone-then-apply-bundle.py"),
            "--dst-dir",
            ".",
            "--git-url",
            repo_ctx.path(workspace_dir + "/third_party/googletest/src"),
            "--git-bundle",
            repo_ctx.path(workspace_dir + "/release/bazel/patches/googletest/fuchsia-support.bundle"),
            "--git-bundle-head",
            "fuchsia-support",
        ],
