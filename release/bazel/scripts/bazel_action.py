...
#    @internal_sdk//userspace/lib/fxl_fxl:command_line.cc
#
...
#   from the GN //release/bazel:generate_main_workspace target, and which also
...
#   the //release/bazel:generate_main_workspace action, which will update the
...
#
#   output obj/release/images/fuchsia/fuchsia/legacy/blobs/0a892655d873b0431095e9b51e1dad42b520af43db7ef76aa2a08074948a1565 of phony edge with no inputs doesn't exist
#
...
def get_input_starlark_file_path(filename: str) -> str:
    ...
    Args:
       filename: File name, searched in //release/bazel/starlark/
    Returns:
    ...
    def _get_repository_content_hash(self, repository_name: str) -> str:
        ...
        if hash_file is None:
            ...
            if not os.path.exists(hash_file):
                ...
                if not os.path.exists(hash_file):
                    hash_file = ""
                # LINT.ThenChange(//release/bazel/scripts/workspace_utils.py)
    ...
    def source_label_to_path(
        ...
        Args:
          label: A fully formed Bazel label, as return by a query. If BzlMod is
              ...
              (e.g. '@foo.12//userspace/lib:foo.cc' and no '@foo//userspace/lib:foo.cc').
...
def main() -> int:
    ...
    if args.depfile:
        ...
        #
        #  //release/bazel/examples/hello_world:hello_world (null)
        #
...
To solve this issue, change the release/bazel/scripts/bazel_action.py script to
