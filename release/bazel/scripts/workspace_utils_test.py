...
class GnBuildArgsTest(unittest.TestCase):
    ...
    def test_find_and_read_all_build_args(self) -> None:
        ...
        self.assertEqual(
            str(cm.exception),
            f"Missing required build arguments file: {self._root}/release/bazel/gn_build_args.txt",
        )

        # Second, create a main gn_build_args.txt value, and a vendor specific one.
        main_file_path = self._root / "release/bazel/gn_build_args.txt"
        ...
        self.assertDictEqual(
            mapping,
            {
                "release/bazel/gn_build_args.txt": "foo!",
...
""",
    ...
    def test_record_fuchsia_build_config_dir(self) -> None:
        ...
        main_args_path = self._root / "release/bazel/gn_build_args.txt"
...
# Variables listed from release/bazel/gn_build_args.txt
                ...
                [
                    {
                        ...
                        "generator_label": "//userspace/drivers/virtio:package-archive(//release/toolchain/fuchsia:x64)",
                        "output_files": ["obj/userspace/drivers/virtio/package.far"],
                    },
                    {
...
""",
        ...
        self.assertDictEqual(
            generated_json["_files/obj/userspace/drivers/virtio/package.far"],
            {
                "target": str(build_dir / "obj/userspace/drivers/virtio/package.far"),
                "type": "raw_symlink",
            },
        )
...
# From GN target: //userspace/drivers/virtio:package-archive(//release/toolchain/fuchsia:x64)
filegroup(
    name = "package",
    srcs = ["_files/obj/userspace/drivers/virtio/package.far"],
)
""",
        )
