...
"""
        ...
        self.assertEqual(
            action_query.filter_query_errors(
                r"""ERROR: /work/space/foo/BUILD.bazel: no such package '@@gn_targets//userspace/foo:gn_artifact
ERROR: Evaluation of query "allpaths(set(//userspace/foo:bazel_target_1 //userspace/foo:bazel_target_2), //userspace/foo/lib:target)" failed.
"""
            ),
            "",
        )
...
ERROR: /tmp/work: no such package '@@gn_targets//userspace/foo:bar' ...
