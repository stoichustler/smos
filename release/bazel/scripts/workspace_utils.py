...
def record_fuchsia_workspace(
  ...
  Git binary path:        {git_bin_path}"""
    ...
    #
    # ```
    # [17:49:48.200] WARN: Project "fuchsia" has path /work/fx-bazel-build, but was found in /work/fx-bazel-build/out/default/gen/release/bazel/output_base/execroot/main.
...
"""
    ...
    # LINT.ThenChange(//release/bazel/toplevel.WORKSPACE.bazel)
    ...
    # LINT.IfChange
    # .jiri_root/ is not exposed to the workspace, but //release/info/BUILD.bazel
    ...
    # LINT.ThenChange(//release/info/info.gni)

    # LINT.IfChange
    generated.record_symlink(
        "workspace/fuchsia_build_generated/fuchsia_in_tree_idk.hash",
        gn_output_dir / "obj/release/bazel/fuchsia_in_tree_idk.hash",
    )

    generated.record_symlink(
        "workspace/fuchsia_build_generated/fuchsia_internal_only_idk.hash",
        gn_output_dir / "obj/release/bazel/fuchsia_internal_only_idk.hash",
    )

    # LINT.ThenChange(//release//bazel/BUILD.gn)
    ...
    # LINT.ThenChange(//release/bazel/scripts/bazel_action.py)
...
class GnBuildArgs(object):
    ...
    See comments in //release/bazel/gn_build_args.txt for their specific
    format.
    ...
    def find_and_read_all_build_args(
        ...
        add_file("release/bazel/gn_build_args.txt", required=True)
...
def record_gn_targets_dir(
    ...
    Args:
        ...
        inputs_manifest_path: Path to an inputs manifest file generated
            ...
            See //release/bazel/bazel_inputs.gni comments for file format.
    ...
    #
    #  _files/obj/userspace/foo/foo.cc.o ----> $NINJA_BUILD_DIR/obj/userspace/foo/foo.cc
    #
    ...
    # files, using . For example _files/obj/userspace/foo/foo.cc.o
...
""".format(
        ...
        #
        # such as "_files/obj/userspace/tee/ta/noop/ta-noop.far", create
