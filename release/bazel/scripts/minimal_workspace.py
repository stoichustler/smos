...
def main(argv: Sequence[str]) -> int:
    ...
    if args.fuchsia_dir:
        ...
        # Assume this script is in 'release/bazel/scripts/'
...
"""
    ...
    bazelrc_content += """
build --platforms=//release/bazel/platforms:{default_platform}
build --host_platform=//release/bazel/platforms:{host_platform}
import remote_services.bazelrc
""".format(
        default_platform="common",  # see release/bazel/platforms/BUILD.bazel
        host_platform="host",
    )
