...
```bash
python3 release/bazel/scripts/export_host_test.py \
    list_tests \
    //release/bazel/host_tests/static_cc_test/...
```
...
[
  {
    ...
    "expects_ssh": false,
    "label": "@//release/bazel/host_tests/static_cc_test:test_program",
...
class HostInfo(object):
    ...
    def test_json_environments(self) -> T.List[T.Dict[str, T.Any]]:
        ...
        # and //release/testing/environments.gni.
