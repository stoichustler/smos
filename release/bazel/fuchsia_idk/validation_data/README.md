...
at `//release/bazel/fuchsia_idk/generate_repository.py` which
...
The `//release/bazel/fuchsia_idk:regression_test` target can be built to
...
```
python3 release/bazel/fuchsia_idk/generate_repository_validation.py \
