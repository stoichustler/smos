...
def _fuchsia_idk_repository(repo_ctx):
    ...
    ret = repo_ctx.execute(
        [
            ...
            "-S",
            repo_ctx.path(Label("@//:release/bazel/fuchsia_idk/generate_repository.py")),
            "--repository-name",
            repo_ctx.name,
            "--output-dir",
            ".",
    ...
    #repo_ctx.symlink(repo_ctx.path(Label("@//:release/bazel/fuchsia_idk/repository.BUILD.bazel")), "BUILD.bazel")
