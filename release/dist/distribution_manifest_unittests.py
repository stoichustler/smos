...
class TestExpandManifestItems(unittest.TestCase):
    def test_regular_entries(self):
        ...
        expected = [
            Entry(destination="bin/foo", source="some/file", label="//userspace/foo"),
            Entry(
                destination="bin/bar", source="other/stuff", label="//userspace/bar"
            ),
        ]
    ...
    def test_regular_entries_with_elf_runtime_dir_conflicts(self):
        ...
        expected_errors = [
            ...
            "  - destination=bin/foo source=some/file label=//userspace/foo elf_runtime_dir=lib",
            "  - destination=bin/foo source=some/alt/file label=//userspace/foo elf_runtime_dir=lib/alt",
        ]
        self.assertEqual(opened_files, set())
    ...
    def test_default_label(self):
        ...
        expected = [
            ...
            Entry(
                source="other/stuff", destination="bin/bar", label="//userspace/bar"
            ),
        ]
    ...
    def test_renamed_entries(self):
        ...
        expected = [
            Entry(destination="bin/bar", source="some/file", label="//userspace/foo"),
    ...
    def test_renamed_entries_with_persistent_entry(self):
        ...
        expected = [
            Entry(destination="bin/bar", source="some/file", label="//userspace/bar"),
            Entry(destination="bin/foo", source="some/file", label="//userspace/foo"),
        ]
        self.assertListEqual(result, expected)
        self.assertEqual(opened_files, set())
    ...
    def test_renamed_entries_with_resource_errors(self):
        ...
        expected_errors += [
            ...
            "  - destination=bin/bar source=some/foo label=//userspace/bar",
            "  - destination=bin/foo source=some/foo label=//userspace/foo",
        ]
    ...
    def test_duplicates_same_content(self):
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            expected = [
                ...
                Entry(
                    destination="bin/foo", source=file1_path, label="//userspace/foo"
                ),
            ]
    ...
    def test_duplicates_source_conflict(self):
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            expected = [
                ...
                Entry(
                    destination="bin/foo", source=file1_path, label="//userspace/foo1"
                ),
            ]
            ...
            expected_error += "   - source=%s label=//userspace/foo1\n" % file1_path
            expected_error += "   - source=%s label=//userspace/foo2\n" % file2_path
