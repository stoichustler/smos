...
def _get_ninja_output_dir(repo_ctx):
    ...
    # used by update-workspace.py, e.g. `gen/release/bazel`. This code assumes
    ...
    config_path = _get_fuchsia_source_relative_path(
        repo_ctx,
        "release/bazel/config/main_workspace_top_dir",
    )
    ...
    # for example when invoking Bazel directly from //release/bazel_sdk/tests/
...
def _get_rbe_config(repo_ctx):
    ...
    rewrapper_config_path = _get_fuchsia_source_relative_path(
        repo_ctx,
        "release/rbe/fuchsia-rewrapper.cfg",
    )

    reproxy_config_path = _get_fuchsia_source_relative_path(
        repo_ctx,
        "release/rbe/fuchsia-reproxy.cfg",
    )
