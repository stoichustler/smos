...
def compute_clang_features(host_os, host_cpu, target_os, target_cpu):
    ...
    #
    # ```
    # ERROR: ..../workspace/build/bazel/tests/hello_world/BUILD.bazel:5:10: Compiling release/bazel/tests/hello_world/main.cc failed: undeclared inclusion(s) in rule '//release/bazel/tests/hello_world:hello_world':
    # this rule is missing dependency declarations for the following files included by 'release/bazel/tests/hello_world/main.cc':
    ...
    # Target //release/bazel/tests/hello_world:hello_world failed to build
    # ```
