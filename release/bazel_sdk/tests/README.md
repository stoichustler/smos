...
- A local Bazel SDK directory.
  ...
  `//release/bazel/bazel_sdk/README.md`.
...
- `fx build //release/bazel/bazel_sdk:final_fuchsia_sdk.validation`
...
fx build //release/bazel:final_fuchsia_in_tree_idk
LOCAL_IDK="$(fx get-build-dir)/gen/release/bazel/fuchsia_in_tree_idk"
...
LOCAL_SDK="$(fx get-build-dir)/gen/release/bazel/fuchsia_sdk"
...
```sh
fx build //release/bazel:final_fuchsia_in_tree_idk
IDK="$(fx get-build-dir)/gen/release/bazel/fuchsia_in_tree_idk"
...
in `//release/bazel/bazel_sdk/README.md`:
...
OUTPUT_BASE="$(fx get-build-dir)/gen/release/bazel/output_base"
