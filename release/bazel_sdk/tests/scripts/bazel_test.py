...
See //release/bazel/bazel_sdk/README.md for more details about these three
categories.
"""
...
class BazelRepositoryMap(object):
    ...
    def __init__(
        ...
        self._overrides: T.Dict[str, Path] = {
            ...
            / "release/bazel/local_repositories/rules_java",
            "remote_coverage_tools": fuchsia_source_dir
            / "release/bazel/local_repositories/remote_coverage_tools",
            "rules_fuchsia": fuchsia_source_dir
            / "release/bazel_sdk/bazel_rules_fuchsia",
        }
        ...
        # //release/bazel/scripts/bazel_action.py because there are way less edge
        ...
        if not explicit_fuchsia_sdk:
            self._internal_overrides["fuchsia_sdk"] = (
                self._fuchsia_source_dir / "release/bazel_sdk/bazel_rules_fuchsia"
            )
    ...
    def resolve_bazel_path(self, bazel_path: str) -> T.Optional[Path]:
        ...
        #
        #   //release/bazel_sdk/bazel_rules_fuchsia/api_version.bzl does
        #     not exist.
        #
...
def main() -> int:
    ...
    downloader_config_file = (
        fuchsia_source_dir / "release/bazel/config/no_downloads_allowed.config"
    )
