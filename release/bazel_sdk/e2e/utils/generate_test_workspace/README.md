...
### Layout:
    ...
    //out/default/host_x64/gen/release/bazel_sdk/e2e/test_workspace
    ...
    │   ├── fuchsia_sdk -> ../../../../../../../gen/release/bazel/fuchsia_sdk
    │   └── googletest
...
1) Add the tests to your build graph:
    ...
    `fx set <product>.<board> --with //release/bazel_sdk/e2e:tests`
