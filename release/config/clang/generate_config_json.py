...
#   a list of scopes. See //release/toolchain/runtime/toolchain_runtime_deps.gni for details.
#
...
#
#   NOTE: Used by //release/config/profile/BUILD.gn
#
...
def main() -> int:
    ...
    for clang_target in _ALL_TARGETS:
        ...
        # LINT.ThenChange(//release/config/fuchsia/BUILD.gn)

        # LINT.IfChange
        get_clangxx_file_path(
            "libclang_rt_profile_a", f"libclang_rt.profile{static_ext}"
        )
        # LINT.ThenChange(//release/config/profile/BUILD.gn)
        ...
        # LINT.ThenChange(//release/config/sanitizers/BUILD.gn)
    ...
    # LINT.ThenChange(//release/toolchain/runtime/toolchain_runtime_deps.gni)
