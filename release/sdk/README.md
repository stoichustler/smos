...
[//release/sdk/meta/](meta), and provide an external contract for SDK-generating
...
[//release/bazel_sdk/README.md](/release/bazel_sdk/README.md) and
[//release/bazel/fuchsia_bazel_sdk.gni](/release/bazel/fuchsia_bazel_sdk.gni).
...
- [`sdk_shared_library`](/release/cpp/sdk_shared_library.gni)
- [`sdk_source_set`](/release/cpp/sdk_source_set.gni)
- [`sdk_host_tool`](/release/sdk/sdk_host_tool.gni)

Some language-specific targets are also SDK-ready:
- [`dart_library`](/release/dart/dart_library.gni)
- [`fidl_library`](/release/fidl/fidl_library.gni)
- [`go_binary`](/release/go/go_binary.gni)
