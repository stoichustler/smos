...
def generate_bazel_content_hash_files(
    ...
    Args:
        ...
        definitions_json: The JSON value of the `$BUILD_DIR/bazel_content_hashes.json` file
            generated at `gn gen` time (see //release/bazel:bazel_content_hashes_json).
...
def main() -> int:
    ...
    if not args.symlinks_only:
        ...
        regenerator_command_args = [
            sys.executable,
            "-S",
            f"{build_dir_to_source_dir}/release/regenerator.py",
        ...
        # by //release/bazel:bazel_content_hashes_json
        ...
        # LINT.ThenChange(//release/rbe/BUILD.gn)
    ...
    # These symlink help debug Bazel issues. See //release/bazel/README.md
