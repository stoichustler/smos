...
[clippy.gni]: https://cs.opensource.google/fuchsia/fuchsia/+/main:release/rust/clippy.gni
...
```
$ grep "couldn't find" /tmp/migration_log.txt| grep -v //userspace/tests/fidl/source_compatibility/
    couldn't find //userspace/developer/ffx/daemon/protocols:ffx_daemon_protocols_lib
    couldn't find //userspace/developer/ffx:ffx
    couldn't find //userspace/lib/fuchsia-cxx/examples/basic:example_blobstore_rustc_library
    couldn't find //userspace/storage/fuchsia-fatfs:fatfs
    couldn't find //userspace/storage/fxfs:fxfs
    couldn't find //userspace/sys/pkg/lib/fuchsia-pkg:lib_test
```
