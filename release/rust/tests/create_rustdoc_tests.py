...
class Config:
    ...
    def render_as_gn_test(self, path: Path):
        ...
        build = (
            ...
            f"# Use of this source code is governed by a BSD-style license that can be\n"
            f"# found in the LICENSE file.\n"
            f'import("//release/python/python_host_test.gni")\n'
            f'import("//release/rust/rustc_binary.gni")\n'
            f'import("//release/rust/rustc_library.gni")\n'
            f'import("//release/rust/rustc_macro.gni")\n'
            f'import("//release/testing/host_test_data.gni")\n'
            f"\n"
            f"# Generated by //release/rust/tests/create_rustdoc_tests.py\n"
...
def main(args: Namespace):
    ...
    if args.fuchsia_destination is not None:
        ...
        gn_test_build = "".join(
            f'"//release/rust/tests/rustdoc/{c.name}", ' for c in configs
        )
...
def _main_arg_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        "--fuchsia-destination",
        default=Path("release/rust/tests/rustdoc").resolve(),
        type=Path,
