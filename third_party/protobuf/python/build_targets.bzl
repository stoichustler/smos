...
def build_targets(name):
    ...
    internal_copy_files(
        ...
        srcs = [
            ...
            "//userspace/google/protobuf:descriptor_proto_srcs",
            "//userspace/google/protobuf/compiler:plugin.proto",
        ],
        strip_prefix = "src",
    )
    ...
    native.cc_binary(
        ...
        deps = [
            ":proto_api",
            "//userspace/google/protobuf",
            "//userspace/google/protobuf:port",
            "//userspace/google/protobuf:protobuf_lite",
            "//userspace/google/protobuf/io",
            "//userspace/google/protobuf/io:tokenizer",
            "//userspace/google/protobuf/stubs:lite",
            "//userspace/google/protobuf/util:differencer",
    ...
    internal_copy_files(
        ...
        srcs = [
            ...
            "//userspace/google/protobuf/util:test_proto_srcs",
        ],
        strip_prefix = "src",
    )
    ...
    internal_copy_files(
        ...
        testonly = 1,
        srcs = [
            "//userspace/google/protobuf:test_messages_proto2.proto",
            "//userspace/google/protobuf:test_messages_proto3.proto",
        ],
        strip_prefix = "src",
    )
    ...
    internal_copy_files(
        ...
        srcs = [
            "//userspace/google/protobuf:cpp_features_proto_srcs",
        ],
        strip_prefix = "src",
    )
    ...
    internal_py_test(
        ...
        data = ["//userspace/google/protobuf:testdata"],
    )
