...
#ifndef SRC_PERFORMANCE_TRACE_TESTS_INTEGRATION_TEST_UTILS_H_
#define SRC_PERFORMANCE_TRACE_TESTS_INTEGRATION_TEST_UTILS_H_
...
#endif  // SRC_PERFORMANCE_TRACE_TESTS_INTEGRATION_TEST_UTILS_H_
