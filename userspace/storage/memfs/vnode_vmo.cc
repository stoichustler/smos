...
#include "userspace/storage/memfs/vnode_vmo.h"
...
VnodeVmo::VnodeVmo(Memfs& memfs, zx_handle_t vmo, zx_off_t offset, zx_off_t length)
    : Vnode(memfs), vmo_(vmo), offset_(offset), length_(length) {
