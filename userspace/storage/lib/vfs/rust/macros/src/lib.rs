...
/// See [//userspace/storage/lib/vfs/rust:vfs/src/lib.rs] for the documentation for this macro usage.
//
// TODO(https://fxbug.dev/42111373) It would be nice to provide support for "shorthand" syntax for the on_read
...
fn pseudo_directory_impl(input: TokenStream) -> TokenStream {
    ...
    let (dir_var, constructor, result) = match parsed.assign_to {
        ...
        None => {
            // TODO(https://fxbug.dev/42111374) Remove the underscores when span becomes Span::def_site().
