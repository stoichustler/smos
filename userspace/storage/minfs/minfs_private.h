...
#include "userspace/storage/lib/vfs/cpp/watcher.h"
...
#include "userspace/storage/minfs/minfs.h"
#include "userspace/storage/minfs/superblock.h"
#include "userspace/storage/minfs/transaction_limits.h"
#include "userspace/storage/minfs/writeback.h"

#ifdef __Fuchsia__
#include "userspace/storage/minfs/vnode_allocation.h"
#endif

#include "userspace/storage/minfs/allocator/allocator.h"
#include "userspace/storage/minfs/allocator/inode_manager.h"
#include "userspace/storage/minfs/bcache.h"
#include "userspace/storage/minfs/vnode.h"
...
class Minfs final : public TransactionalFs {
 ...
 private:
  ...
  // TODO(https://fxbug.dev/42059522): Stop accessing outside `dispatcher_` thread.
