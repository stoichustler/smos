...
async fn main() -> Result<(), Error> {
    ...
    // TODO(https://fxbug.dev/42069366): //userspace/tests/oom looks for "fshost: lifecycle handler ready" to
    ...
    // TODO(https://fxbug.dev/42069366): //userspace/tests/oom looks for "received shutdown command over lifecycle
