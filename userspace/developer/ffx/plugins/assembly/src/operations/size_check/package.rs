    ...
    fn blob_size_are_summed_test() {
        ...
        test_fs.write(
            ...
            json!({"package_set_budgets":[{
                ...
                "packages": [
                    test_fs.path("obj/userspace/sys/pkg/bin/pkg-cache/pkg-cache/package_manifest.json"),
                ]
            }]}),
        );
        test_fs.write(
            "obj/userspace/sys/pkg/bin/pkg-cache/pkg-cache/package_manifest.json",
            json!({
                "version": "1",
    ...
    fn blob_shared_by_two_budgets_test() {
        ...
        test_fs.write(
            ...
            "name": "Software Deliver",
                ...
                "packages": [
                    test_fs.path("obj/userspace/sys/pkg/bin/pkg-cache/pkg-cache/package_manifest.json"),
                    test_fs.path("obj/userspace/sys/pkg/bin/pkgfs/pkgfs/package_manifest.json"),
                ]
            },{
                "name": "Connectivity",
                "creep_budget_bytes": 1i32,
                ...
                "packages": [
                    test_fs.path( "obj/userspace/connectivity/bluetooth/core/bt-gap/bt-gap/package_manifest.json"),]
            }]}),
        );
        test_fs.write(
            "obj/userspace/sys/pkg/bin/pkg-cache/pkg-cache/package_manifest.json",
        ...
        test_fs.write(
            "obj/userspace/sys/pkg/bin/pkgfs/pkgfs/package_manifest.json",
            json!({
                "version": "1",
                "repository": "testrepository.com",
                "package": {
        ...
        test_fs.write(
            "obj/userspace/connectivity/bluetooth/core/bt-gap/bt-gap/package_manifest.json",
            json!({
                "version": "1",
                "repository": "testrepository.com",
                "package": {
        ...
        test_fs.assert_eq(
            ...
            json!({
                "Software Deliver": {
                  ...
                  "used_bytes": 158,
                  "package_breakdown": {
                    test_fs.path("obj/userspace/sys/pkg/bin/pkg-cache/pkg-cache/package_manifest.json").to_string(): {
                    ...
                    test_fs.path("obj/userspace/sys/pkg/bin/pkgfs/pkgfs/package_manifest.json").to_string(): {
                      "proportional_size": 79,
                      "used_space_in_blobfs": 159,
                      "name": "pkgfs",
                      "blobs": [
                ...
                "Connectivity": {
                  ...
                  "used_bytes": 159,
                  "package_breakdown": {
                    test_fs.path("obj/userspace/connectivity/bluetooth/core/bt-gap/bt-gap/package_manifest.json").to_string(): {
        ...
        test_fs.write(
            ...
            json!({
                "package_set_budgets":[{
                    ...
                    "budget_bytes": 256i32,
                    "packages": [
                        test_fs.path("obj/userspace/my_program/package_manifest.json"),
                    ]
                }]
            }),
        );
        test_fs.write(
            "obj/userspace/my_program/package_manifest.json",
            json!({
                "version": "1",
                "package": {
                    "name": "pkg-cache",
