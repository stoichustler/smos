...
const MILESTONE: &str = env!("SMOS_SDK_MILESTONE");
...
mod test {
    ...
    async fn test_core_manifest() {
        ...
        assert_eq!(
            "//userspace/developer/debug/zxdb:zxdb_sdk(//release/toolchain:host_x64)",
            atoms[0].gn_label
        );
        ...
        assert_eq!(
            "//userspace/developer/ffx/plugins/assembly:sdk(//release/toolchain:host_x64)",
            atoms[3].gn_label
        );
