...
#include "userspace/virtualization/bin/vmm/controller/virtio_balloon.h"
#include "userspace/virtualization/bin/vmm/controller/virtio_block.h"
#include "userspace/virtualization/bin/vmm/controller/virtio_console.h"
#if !defined(SMOS_MINIMAL_VMM)
#include "userspace/virtualization/bin/vmm/controller/virtio_gpu.h"
#include "userspace/virtualization/bin/vmm/controller/virtio_input.h"
#endif
#include "userspace/virtualization/bin/vmm/controller/virtio_mem.h"
#if !defined(SMOS_MINIMAL_VMM)
#include "userspace/virtualization/bin/vmm/controller/virtio_net.h"
#endif
#include "userspace/virtualization/bin/vmm/controller/virtio_rng.h"
#if !defined(SMOS_MINIMAL_VMM)
#include "userspace/virtualization/bin/vmm/controller/virtio_sound.h"
#endif
#include "userspace/virtualization/bin/vmm/controller/virtio_vsock.h"
#if !defined(SMOS_MINIMAL_VMM)
#include "userspace/virtualization/bin/vmm/controller/virtio_wl.h"
#endif
#include "userspace/virtualization/bin/vmm/guest.h"
#include "userspace/virtualization/bin/vmm/interrupt_controller.h"
#include "userspace/virtualization/bin/vmm/platform_device.h"
#include "userspace/virtualization/bin/vmm/uart.h"

#if __aarch64__
#include "userspace/virtualization/bin/vmm/arch/arm64/pl031.h"
#elif __x86_64__
#include "userspace/virtualization/bin/vmm/arch/x64/acpi.h"
#include "userspace/virtualization/bin/vmm/arch/x64/io_port.h"
#include "userspace/virtualization/bin/vmm/arch/x64/page_table.h"
#endif
