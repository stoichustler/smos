...
#ifndef SRC_BRINGUP_BIN_CRITICAL_SERVICES_CRASHSVC_EXCEPTION_HANDLER_H_
#define SRC_BRINGUP_BIN_CRITICAL_SERVICES_CRASHSVC_EXCEPTION_HANDLER_H_
...
#endif  // SRC_BRINGUP_BIN_CRITICAL_SERVICES_CRASHSVC_EXCEPTION_HANDLER_H_
