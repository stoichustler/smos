...
#if !defined(SMOS_HEADLESS_CRITICAL_SERVICES)
...
#include "userspace/bringup/bin/critical-services/crashsvc/crashsvc.h"
#include "userspace/bringup/bin/critical-services/monitor.h"
#include "userspace/bringup/bin/critical-services/oom_watcher.h"
#include "userspace/bringup/bin/critical-services/pwrbtn_monitor_config.h"
