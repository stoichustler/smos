...
const std::set<std::string> kCreateThreadSymbolsDriversAllowlist = {
    ...
    "#meta/virtio-gpu-display.cm",
    "#meta/virtual-audio-legacy-driver.cm",
...
// LINT.ThenChange(//release/bazel_sdk/bazel_rules_fuchsia/fuchsia/private/driver_restricted_symbols.txt)
