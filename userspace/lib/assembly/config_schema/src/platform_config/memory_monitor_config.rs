...
pub enum MemoryMonitorVersion {
    ...
    #[default]
    Default,
    /// Memory Monitor 1, as implemented in //userspace/developer/memory/monitor/,
    /// which uses process-based memory attribution.
    V1,
    /// Memory Monitor 1, with memory profiling enabled.
    V1WithProfiling,
    /// Memory Monitor 2, as implemented in //userspace/performance/memory/attribution/monitor,
