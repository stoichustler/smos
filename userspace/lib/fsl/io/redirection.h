...
#ifndef SRC_LIB_FSL_IO_REDIRECTION_H_
#define SRC_LIB_FSL_IO_REDIRECTION_H_

#include <lib/zx/handle.h>
#include <lib/zx/socket.h>

#include "userspace/lib/fxl/fxl_export.h"
...
FXL_EXPORT zx_status_t CreateRedirectedSocket(int startup_fd, zx::socket* out_socket,
                                              StartupHandle* out_startup_handle);

}  // namespace fsl

#endif  // SRC_LIB_FSL_IO_REDIRECTION_H_
