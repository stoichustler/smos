...
impl PackageManifestList {
    ...
    pub fn from_reader(
        ...
        let versioned_list = match serde_json::from_slice(bytes.as_slice())? {
...
mod tests {
    ...
    fn test_serialize() {
        let package_manifest_list = PackageManifestList::from(vec![
            "obj/release/images/config-data/package_manifest.json".into(),
            "obj/release/images/shell-commands/package_manifest.json".into(),
            "obj/userspace/sys/component_index/component_index/package_manifest.json".into(),
        ]);
            ...
            json!(
                {
                    "content": {
                        "manifests": [
                            "obj/release/images/config-data/package_manifest.json",
                            "obj/release/images/shell-commands/package_manifest.json",
                            "obj/userspace/sys/component_index/component_index/package_manifest.json",
                        ]
                    },
                    "version": "1"
                }
    ...
    fn test_iter_from_reader_json_v1() {
        ...
        assert_eq!(
            PackageManifestList(VersionedPackageManifestList::Version1(PackageManifestListV1 {
                ...
                manifests: vec![
                    manifest_dir.join("obj/release/images/config-data/package_manifest.json"),
                    manifest_dir.join("obj/release/images/shell-commands/package_manifest.json"),
                    manifest_dir
                        .join("obj/userspace/sys/component_index/component_index/package_manifest.json"),
                ]
            })),
            package_manifest_list
        );
